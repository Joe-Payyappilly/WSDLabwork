...
xml_file="2347227_Lab-Exam 2\joke.xml"
xsd_file="2347227_Lab-Exam 2\joke.xsd"
...
xml_tree = etree.parse("2347227_Lab-Exam 2\joke.xml")

xsl_tree = etree.parse("2347227_Lab-Exam 2\joke.xsl")

transformer = etree.XSLT(xsl_tree)
transformed_tree = transformer(xml_tree)
output_html_filename = "joketable.html"
