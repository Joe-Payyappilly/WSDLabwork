...
xml_file="Lab Exercise - 5\product.xml"
xsd_file="Lab Exercise - 5\product.xsd"
...
xml_tree = etree.parse("Lab Exercise - 5\product.xml")

xsl_tree = etree.parse("Lab Exercise - 5\product.xsl")
